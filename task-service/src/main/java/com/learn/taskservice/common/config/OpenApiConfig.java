...
import com.learn.taskservice.common.exception.ApiError;
 ...
 * Codes specific to one endpoint (the 404 on a single-task lookup) are declared on that
            ...
            openApi.getPaths()
                    ...
                    .forEach(pathItem -> pathItem.readOperations().forEach(operation -> {
                        ...
                        addIfAbsent(
                                responses,
                                "403",
                                "Forbidden - either the token's role does not permit this operation, or the "
