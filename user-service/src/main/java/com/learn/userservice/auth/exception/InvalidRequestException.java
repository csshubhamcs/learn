 ...
 * field, an unknown realm role. Maps to HTTP 400 and its message is returned to the client,
 * so it may only ever be constructed with text written for a caller to read.
 *
